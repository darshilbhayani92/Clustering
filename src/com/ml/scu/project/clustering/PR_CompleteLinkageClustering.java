...
public class PR_CompleteLinkageClustering {
	...
	protected void updateDataPoints(int attribute1, int attribute2, Double[][] distanceBetPoints) {
		...
		for (int x = 0; x < distanceBetPoints.length; x++) {
			...
			//System.out.println("distanceBetPoints[attribute2][x]....ML_CompleteLinkageClustering...."+distanceBetPoints[attribute2][x]);
		}
	}
}
